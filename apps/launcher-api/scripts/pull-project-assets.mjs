...
// `editor-fonts/`, `editor-symbols/`, `effects/`, `clips/`). Each is ENTIRELY generated
// by an export step (the game never commits into them), so any local file there that the
...
const GENERATED_SUBTREES = ['editor-art', 'editor-fonts', 'editor-symbols', 'effects', 'clips'];

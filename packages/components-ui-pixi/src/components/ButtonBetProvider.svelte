...
<script lang="ts">
	...
	// The sound comes off the SAME `isIdle` the press body decides on, so a slam can never announce
	// itself with the bet whoosh (it did — the sound was broadcast before the decision was made).
	const onpress = () => {

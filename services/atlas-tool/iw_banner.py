...
This file is self-contained on purpose: each tool keeps its own copy so it
stays standalone when installed/launched individually by the Invisible
Launcher. Keep the copies in sync.
"""

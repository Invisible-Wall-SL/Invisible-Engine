...
already reads (TexturePacker JSON + our AI manifest) and never re-packs the page: the
pixels and every rect stay byte-identical, which is the whole point of "reuse it as is".

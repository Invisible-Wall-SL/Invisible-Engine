"""R2 object storage + local-staging sync for the cloud Sheet Maker.
...
R2 keys mirror the staging layout exactly under a single project prefix, e.g.
    sheet_maker/cloud/<project>/input/<sheet>/sprite.png
    sheet_maker/cloud/<project>/output/<sheet>/<basename>.png
    sheet_maker/cloud/<project>/output/<sheet>/atlas_manifest_<basename>.json

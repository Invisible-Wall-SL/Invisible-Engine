 ...
 *
 * Unlike the other gates this drives the REAL facade (`stake-facade.ts`) against the REAL mock, so it
...
const facade = await import('../packages/rgs-translator-eagaming/stake-facade.ts');

const HERE = dirname(fileURLToPath(import.meta.url));
/** Stake's BOOK_AMOUNT_MULTIPLIER — book-event amounts are fixed-point bet multipliers. */

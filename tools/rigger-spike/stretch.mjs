...
const deps = [
	...
	...['slotChannel', 'deformArrForTrack', 'sequenceArrForTrack', 'seqEffectiveDelay', 'scaleSequenceDelays', 'pinSequenceDelayAfter', 'seqDelaysBefore', 'seqDelaysRestore',
		'retimeSequenceKey', 'copySequenceKey',
